...
#
# Script generated by Vivado on Thu Jun 26 19:26:20 +0530 2025
...
# script info
echo -e "blk_mem_gen_13.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_13 xil_defaultlib.blk_mem_gen_13 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_mem_gen_13 -key {Behavioral:sim_1:Functional:blk_mem_gen_13} -tclbatch cmd.tcl -log simulate.log
}
