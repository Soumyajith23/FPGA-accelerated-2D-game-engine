...
#
# Script generated by Vivado on Sun Jun 29 05:32:33 +0530 2025
...
# script info
echo -e "blk_mem_gen_14.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_14 xil_defaultlib.blk_mem_gen_14 xil_defaultlib.glbl -log elaborate.log
}
