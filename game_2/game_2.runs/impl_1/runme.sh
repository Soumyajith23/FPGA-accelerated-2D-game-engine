...
HD_PWD='C:/Users/kisho/game_2/game_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_module2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_module2.tcl -notrace
